#include <cstdio>
#include <bits/stdc++.h>
#include "cluster_reduce/CMSketch.h"
#include "cluster_reduce/CSketch.h"
#include "cluster_reduce/CUSketch.h"
#include "cluster_reduce/CMMSketch.h"
#include "cluster_reduce/CMLSketch.h"
#include "cluster_reduce/CSMSketch.h"
#include "trace.h"
...
double test_sketch(SketchClassT* p_sketch, int read_num, int d, int w,
    ...
    vector<pair<int, string>> ans = groundtruth(input, read_num);
    p_sketch->init(w, d);
    for (auto pkt : input) {
